...
const buttyesFun= () => {
    ...
    new_prompt.innerText = "Hemos recibido la información de su pedido. Muchas gracias." ;
...
const validarPedido = () => {
    ...
    if (msg === ""){
        ...
        let form_don = document.getElementById("form-pedido");
...
submitBtn.addEventListener("click", validarPedido);  